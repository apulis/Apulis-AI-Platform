    ...
    <MuiThemeProvider theme={useCheckIsDesktop ? theme : tableTheme}>
      {
        nodeStatus ?  <MaterialTable
          ...
          columns={[
            ...
            {title: 'Device', field: 'gpu_capacity', render: (rowData: any) => <span>{checkObjIsEmpty(rowData['gpu_capacity']) ? 0 :  (Number)(sumValues(rowData['gpu_capacity']))}</span>, customSort: (a: any, b: any) => { return sumValues(a['gpu_capacity']) - sumValues(b['gpu_capacity'])}  },
