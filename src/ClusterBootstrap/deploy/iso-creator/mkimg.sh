...
LABEL coreosworker
    ...
    TEXT HELP
Deploy worker node for cluster atlas (3924e5ca-00c9-4245-a49f-08f817d1d954). The CoreOS system is going to be installed on the
...
#    TEXT HELP
#Deploy master node for cluster atlas (3924e5ca-00c9-4245-a49f-08f817d1d954). The CoreOS system is going to be installed on the
#first hard drive (/dev/sda). ALL THE DATA ON /dev/sda WILL BE ERASED.
#    ENDTEXT
...
LABEL coreosetcd
    ...
    TEXT HELP
Deploy ETCD node for cluster atlas (3924e5ca-00c9-4245-a49f-08f817d1d954). The CoreOS system is going to be installed on the
first hard drive (/dev/sda). ALL THE DATA ON /dev/sda WILL BE ERASED.
    ENDTEXT
EOF
}
